...
const BenefitCard = ({ 
  ...
  return (
    ...
    >
      <div className="flex-shrink-0 w-12 h-12 rounded-lg glass-morphism flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-white/10 bg-white/5 mb-4">
            <span className="text-xs font-medium text-white/80">Institution Benefits</span>
          </div>
          <h2 
            ref={ref}
            className={`text-3xl md:text-4xl font-display font-bold text-gradient mb-6 transition-all duration-700 ease-out ${
              inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
            Elevate Your Lending Operations
          </h2>
          <p className={`text-lg text-white/70 max-w-2xl mx-auto transition-all duration-700 ease-out ${
              inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6">
          <div className="lg:col-span-2 h-full">
            <div className="h-full glass-morphism rounded-xl p-8 md:p-10 overflow-hidden relative group">
              ...
              <h3 className="text-2xl font-display font-medium text-white mb-4 relative z-10">Comprehensive Credit Intelligence</h3>
          ...
          <div className="h-full">
            <div className="h-full glass-morphism rounded-xl p-8 overflow-hidden relative group">
              ...
              <h3 className="text-xl font-display font-medium text-white mb-4 relative z-10">Enhanced Decision-Making</h3>
              <p className="text-white/70 mb-6 relative z-10">
          ...
          <div className="h-full">
            <div className="h-full glass-morphism rounded-xl p-8 overflow-hidden relative group">
              <div className="absolute -right-20 -bottom-20 w-40 h-40 rounded-full bg-fintech-700/20 blur-3xl group-hover:bg-fintech-600/30 transition-all duration-700"></div>
              <h3 className="text-xl font-display font-medium text-white mb-4 relative z-10">Operational Excellence</h3>
              <p className="text-white/70 mb-6 relative z-10">
          ...
          <div className="lg:col-span-4">
            <div className="glass-morphism rounded-xl p-8 md:p-10 overflow-hidden relative group">
              <div className="absolute -right-20 -bottom-20 w-64 h-64 rounded-full bg-fintech-700/20 blur-3xl group-hover:bg-fintech-600/30 transition-all duration-700"></div>
              <h3 className="text-2xl font-display font-medium text-white mb-6 relative z-10">Business Impact</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 relative z-10">
                <div className="text-center p-6 neo-blur rounded-lg">
                  <div className="text-4xl font-display font-bold text-gradient-blue mb-2">42%</div>
                  <p className="text-white/70 text-sm">Reduction in risk assessment time</p>
                </div>
