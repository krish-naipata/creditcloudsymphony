  ...
  return (
    <div ref={ref} className="flex">
      <div className="flex flex-col items-center mr-6">
        <div className={`w-10 h-10 rounded-full flex items-center justify-center z-10 transition-all duration-700 ease-out ${
        ...
        {!isLast && (
          <div className={`w-0.5 grow bg-fintech-800 mt-2 transition-all duration-1000 ease-out ${
            inView ? 'opacity-100 h-full' : 'opacity-0 h-0'
          }`} style={{ transitionDelay: `${delay + 200}ms` }}></div>
        )}
      </div>
      <div className={`pb-10 transition-all duration-700 ease-out ${
...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-fintech-900/10 to-transparent"></div>
