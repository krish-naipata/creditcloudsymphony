      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-white/10 bg-white/5 mb-6 animate-fade-in backdrop-blur-sm">
            <span className="text-xs font-medium text-white/80">Unified Credit Intelligence for Modern Finance</span>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-display font-bold text-gradient mb-6 animate-fade-in" style={{animationDelay: '100ms'}}>
            A Single Source of <br className="hidden md:block" /> Credit Truth
          </h1>
          
          <p className="text-lg md:text-xl text-white/70 max-w-3xl mb-8 animate-fade-in" style={{animationDelay: '200ms'}}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 w-full">
            <div className="glass-morphism rounded-xl p-6 text-center animate-slide-in-bottom" style={{animationDelay: '400ms'}}>
              ...
              <h3 className="text-white font-medium mb-1">Normalized Scoring</h3>
              <p className="text-white/60 text-sm">Unified credit profiles across bureaus</p>
            </div>
